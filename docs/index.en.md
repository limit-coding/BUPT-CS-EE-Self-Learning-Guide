...
This guide is based on [CS Self-Learning Guide](https://csdiy.wiki) and curated for BUPT students as a Communication/Computer Science self-learning resource.
...
If you are new to programming, [CS61A](https://cs61a.org/) is a solid first step: clear site, open textbook, and well-designed labs and projects.
...
Thanks to all who open-source courses and materials. This guide is derived from [CS Self-Learning Guide](https://github.com/PKUFlyingPig/cs-self-learning); we thank the original project and its contributors.

## Contributing

Pull requests are welcome. To add a new course, see [template](../template.md) and the nav in [mkdocs.yml](../mkdocs.yml).
